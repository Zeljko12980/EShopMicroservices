...
namespace Ordering.Infrastructure.Data.Extensions
{
    internal class InitialData
    {
        ...
        new List<Customer>
        {
        Customer.Create(CustomerId.Of(new Guid("58c49479-ec65-4de2-86e7-033c546291aa")), "zeljko", "ikanoviczeljko095@gmail.com"),
        ...
        public static IEnumerable<Order> OrdersWithItems
        {
            get
            {
                var address1 = Address.Of("zeljko", "ikanovic", "ikanoviczeljko095@gmail.com", "Srpske Sloge 22", "Republika Srpska", "Istocno Sarajevo", "71221");
                var address2 = Address.Of("john", "doe", "john@gmail.com", "Broadway No:1", "England", "Nottingham", "08050");

                var payment1 = Payment.Of("zeljko", "4242424242424242", "12/28", "355", 1);
